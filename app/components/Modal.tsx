const Modal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
        <div className="bg-white shadow-lg max-w-lg mx-4 sm:mx-0 relative">
          <button
            onClick={onClose}
          ...
          <div className="bg-slate-100 p-6 mt-[-1px]">
            ...
            <div className="text-center mt-8">
              <p className="text-md font-semibold text-gray-800 mb-2">Zapisy pod numerem telefonu:</p>
              <p className="text-xl font-bold text-blue-100 bg-blue-400 p-2 inline-block">601-806-058</p>
            </div>
          </div>
        </div>
      </div>
